...
lazy val root = (project in file("."))
  ...
  .settings(
    ...
    // concatenate js
    Concat.groups := Seq(
      "javascripts/coronavirusjsscalculatorfrontend-app.js" ->
        group(Seq("javascripts/show-hide-content.js", "javascripts/coronavirusjsscalculatorfrontend.js"))
    ),
    ...
    includeFilter in uglify := GlobFilter("coronavirusjsscalculatorfrontend-*.js")
  )
  .settings(
