...
claimPeriod.details.p1 = You make a claim under the Job Retention Scheme for a period during which one or more of your employees are furloughed. This is the claim period.
claimPeriod.details.p2 = Include all affected employees in one claim, including employees who start or end furlough on different dates within the claim period.
...
claimPeriod.details.p4 = For the first claim, this is the date the first employee was furloughed (other employees may be furloughed at a later date). The earliest the start date can be is 1 March 2020, which is the date the Job Retention Scheme started.
claimPeriod.details.p5 = If employees are still furloughed after the claim period ends, make another claim later to cover the ongoing furlough period. Claim periods cannot overlap.
claimPeriod.details.heading2 = Claim period end date
claimPeriod.details.p6 = This should be a date that aligns with a payroll run. It can be any date up to 14 days from today’s date. Note that it’s not the same as the furlough end date - furlough may be ongoing at the end of the claim period.
claimPeriod.hint= For example November 2020
...
payDate.title = What’s the last day this employee was paid for before {0}?
payDate.heading = What’s the last day this employee was paid for before {0}?
payDate.p1 = This is the end of the last pay period before the claim started.
payDate.p2 = We’ll use this date to work out all the pay periods that cover your claim.
payDate.details.title = What is a pay period?
payDate.details.p1 = A ‘pay period’ is the period of time that the employee is paid for, such as weekly or monthly. When we ask for the end date of a pay period, it’s the last day they were paid for. It’s different from the ‘pay date’, which is the date the employee actually gets their pay.
payDate.hint = For example 01 11 2020
payDate.error.required.all = Enter the payDate
payDate.error.required.two = The payDate must include {0} and {1}
payDate.error.required = The payDate must include {0}
payDate.error.invalid = Enter a real PayDate
