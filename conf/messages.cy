...
claimPeriodStart.p1 = Your first claim under the Job Support scheme starts from the employee started furlough
claimPeriodStart.p2 = You can claim from 1 November 2020 which is the date the scheme is started
claimPeriodStart.hint= For example 1 11 2020
claimPeriodStart.label = Start date
claimPeriodStart.error.required.all = Enter the claim period start
claimPeriodStart.error.required.two = The claim period start must include {0} and {1}
claimPeriodStart.error.required = The claim period start must include {0}
