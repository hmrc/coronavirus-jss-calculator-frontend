...
startPage.p2 = Remember that across the entire period, the employee must work at least 20% of their hours to be eligible.
...
endPayDate.error.invalid.must.be.after = The last date must be after {0}
endPayDate.error.invalid.must.be.before = The last date must be before claim end ({0})
