...
startPage.p1 = You can use this calculator to calculate the figures you'll need when you complete a claim through the Coronavirus Job Support Scheme. It also breaks down calculations for each pay period for your records.
startPage.p2 = Remember that across the entire period, the employee must work at least 33% of their hours to be eligible.
...
startPage.p4 = The calculator accounts for employees brought back to work from 1 July for some of their normal hours.
startPage.p5 = It can be used by employees if:
startPage.p5.l1 = most of them were paid weekly, two weekly, four weekly or monthly
startPage.p5.l2 = they returned from statutory leave such as maternity leave from August 1.
startPage.p6 = The calculator cannot be used if employees:
startPage.p6.l1 = receive director’s payments outside PAYE
startPage.p6.l2 = have been transferred under TUPE
startPage.p6.l3 = were not employed continuously before their furlough started
startPage.p6.l4 = returned from statutory leave such as maternity leave in the last three months (if the claim period is in July or earlier)
startPage.p6.l5 = receive employer pension contributions outside of an auto-enrolment pension scheme
startPage.p6.l6 = ended furlough then began again during the same claim period
startPage.p6.l7 = receive director’s payments outside PAYE
startPage.p7 = In these cases, you can work out what you can claim manually using the {0} or seek professional advice.
startPage.p8 = It's your responsibility to check the correct amount you claim for.
startPage.p9 = You will need:
startPage.p9.l1 = the claim start date (your first claim is when the first employee started furlough)
startPage.p9.l2 = claim end date
startPage.p9.l3 = pay dates (when the employee gets their pay)
startPage.p9.l4 = dates of pay periods (the time periods their pay covers)
startPage.p9.l5 = regular payment amounts
startPage.p9.l6 = additional payments (such as tips, discretionary bonuses, non-cash payments)
startPage.p9.l7 = date furlough ended, if not ongoing
startPage.p10 = From 1 July, if the employee is flexibly furloughed, will also need:
startPage.p10.l1 = employees usual hours (opens in new tab)
startPage.p10.l2 = actual hours worked
startPage.p10.l3 = hours furloughed
startPage.p11 = Steps to take before calculating your claim (opens in new tab)
