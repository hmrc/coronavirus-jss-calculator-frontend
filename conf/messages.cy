...
claimPeriodStart.p1 = From 1 November, claims must start and end in the same calendar month.
claimPeriodStart.p2 = Make sure the claim periods do not overlap.
claimPeriodStart.details.title = What is a claim period?
claimPeriodStart.details.p1 = You make a claim under the Job Retention Scheme for a period during which one or more of your employees are furloughed. This is the claim period.
claimPeriodStart.details.p2 = Include all affected employees in one claim, including employees who start or end furlough on different dates within the claim period.
claimPeriodStart.details.p3 = You cannot make more than one claim covering the same claim period.
claimPeriodStart.details.heading1 = Claim period start date
claimPeriodStart.details.p4 = For the first claim, this is the date the first employee was furloughed (other employees may be furloughed at a later date). The earliest the start date can be is 1 March 2020, which is the date the Job Retention Scheme started.
claimPeriodStart.details.p5 = If employees are still furloughed after the claim period ends, make another claim later to cover the ongoing furlough period. Claim periods cannot overlap.
claimPeriodStart.details.heading2 = Claim period end date
claimPeriodStart.details.p6 = This should be a date that aligns with a payroll run. It can be any date up to 14 days from today’s date. Note that it’s not the same as the furlough end date - furlough may be ongoing at the end of the claim period.
claimPeriodStart.hint= For example November 2020
claimPeriodStart.label = Select a month
claimPeriodStart.Nov2020 = November 2020
claimPeriodStart.Dec2020 = December 2020
claimPeriodStart.Jan2021 = January 2021
claimPeriodStart.Feb2021 = February 2021
claimPeriodStart.Mar2021 = March 2021
claimPeriodStart.Apr2021 = April 2021
claimPeriodStart.May2021 = May 2021
claimPeriodStart.Jun2021 = June 2021
claimPeriodStart.Jul2021 = July 2021
claimPeriodStart.Aug2021 = August 2021
claimPeriodStart.Sep2021 = September 2021
claimPeriodStart.Oct2021 = October 2021
claimPeriodStart.Nov2021 = November 2021
claimPeriodStart.Dec2021 = December 2021
claimPeriodStart.error.required = Select one value
claimPeriodStart.error.invalid = Enter a real claim period start