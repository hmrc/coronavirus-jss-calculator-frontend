...
object AddMore extends Enumerable.Implicits {
  case object Yes extends WithName("yes") with AddMore
  ...
  def options(form: Form[_])(implicit messages: Messages): Seq[RadioItem] = values.map { value =>
    RadioItem(
      ...
      content = Text(messages(s"addMore.${value.toString}")),
...
object ShortTermWorkingAgreementPeriod extends Enumerable.Implicits {
